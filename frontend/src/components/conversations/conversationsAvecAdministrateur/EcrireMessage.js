...
import AfficherConversationAvecAdministrateur from './AfficherConversation';

export default function EcrireMessageConversationAdministrateur(){
    ...
    const submit = async function(e){
        ...
        try{
            ...
            await Requete.post(
                "/discussionAvecAdministrateur/ecrire/message/" + membreId,
                nouveauMessage,
    ...
    return(
        <div className="container" style={{marginTop: "20px"}}>
            <AfficherConversationAvecAdministrateur membreId={membreId} refresh={refresh} />
            <div className="container" style={{marginTop: "20px"}}>
