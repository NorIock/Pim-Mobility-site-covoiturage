...
export default function ModifierMotifsRefusDemandeDeCovoiturage(){
    ...
    const submit = async function(e){
        ...
        try{
            const majMotif = { motif };
            await Requete.put(
                "/motifsRefusDemandeDeCovoiturage/modifier/" + id,
                majMotif,
    ...
    return(
        <div className="admin-display">
            ...
            <div>
                <Link to="/admin/motif-suite-refus-demande-de-covoiturage/gerer">Retour</Link>
            </div>
        </div>
    )
}