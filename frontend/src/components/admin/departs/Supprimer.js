...
export default function SupprimerDepart(){
    ...
    return(
        ...
        {data === null ? (
            ...
            <div>
                ...
                <h4>Souhaitez-vous supprimer ce départ: <strong>{data.nom}</strong> ?</h4>
                <button onClick={() => supprimer()} className="btn btn-danger">Supprimer</button>
                <p><Link to="/admin/departs/gerer">Retour</Link></p>
            </div>
        )}
        </div>
    )
