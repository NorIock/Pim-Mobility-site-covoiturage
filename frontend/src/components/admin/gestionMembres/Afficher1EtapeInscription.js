...
export default function AfficherTousLesMembre1EtapeInscription(){
    ...
    return(
        <div className="container" style={{marginTop: "80px"}}>
            <div className="affichage-stat">
                <h5>{data.length < 2 ? (<span>Membre qui n'a </span>) : (<span>Membres qui n'ont </span>)}fait qu'une étape de l'inscription: {data.length}</h5>
