...
export default function AfficherTousLesIndisponibles(){
    ...
    return(
        <div className="container" style={{marginTop: "80px"}}>
            <div className="affichage-stat">
                <h5>{data.length < 2 ? (<span>Membre indisponible</span>) : (<span>Membres indisponibles</span>)}: {data.length}</h5>
