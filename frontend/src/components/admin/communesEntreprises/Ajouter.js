...
import AfficherCommune from './Afficher';
import Requete from '../../../middlewares/Requete';
import ErrorNotice from '../../misc/ErrorNotice';

export default function AjouterCommune(){
    ...
    const submit = async function(e){
        ...
        try {
            const newCommune = { nom };
            await Requete.post(
                '/communesEntreprises/ajouter',
                newCommune,
        ...
        <div className="container" style={{marginTop: "80px"}}>
            <form onSubmit={submit}>
                <div className='form-group'>
                    <label><h3>Ajouter une commune:</h3></label>
                    <input
                        type='text'
                        className='form-control'
                        placeholder="Nom de la commune à ajouter"
            ...
            <div>
                <AfficherCommune toChild={toChild}/>
            </div>
        </div>
    )
}