...
export default function AfficherNotificationsToutes(){

    const [data, setData] = useState([]);
    const [origine] = useState("afficher-toutes")
            ...
            {data.length === 0 ? (
                ...
                <div>
                    ...
                    <div style={{textAlign: "center"}}>
                        <h3>Notifications de demande de covoiturage en cours:</h3>
                        ...
                        {data.data.map(notifications =>(
                            <ul className="list-group list-group-flush" key={notifications._id}>
                                ...
                                <div style={{display: "flex", alignItems: "center", justifyContent: "space-between"}}>
                                    <h4>
                                        Notification envoyée à <Link to={"/membre/" + notifications.membre_notif_id}>
