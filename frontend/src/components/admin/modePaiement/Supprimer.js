    ...
    return(
        ...
        {data === null ? (
            ...
            <div>
                ...
                <h4>Souhaitez-vous supprimer ce mode de paiement: <strong>{data.type}</strong> ?</h4>
                <button onClick={() => supprimer()} className="btn btn-danger">Supprimer</button>
                <p><Link to="/admin/modes-paiement/gerer">Retour</Link></p>
            </div>
        )}
        </div>
    )
